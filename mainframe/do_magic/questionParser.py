...
# todo I finished general triangulation use wordnet to check stop words after spell check after lookup table.
...
def parseQuestion(question):
    ...
    #todo this is where the first use of candidates and word net need to be used.
    ...
    #todo this is the next use of candidates or word net
